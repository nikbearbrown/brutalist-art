...
| 4 | **Posting to YouTube** | explainer + terminal | ✨ `youtube/posting-to-youtube` | ✅ | **DONE** — 15/15 beats rendered (235.8s, narrated); 0 MISSING; 0 slates. Standing rules #3/#4 followed exactly. B12 HERO confirmed (dark bg, "THE MACHINE POSTS. / YOU OWN WHAT SHIPS.", machine/human split). Real figures from PUBLISH-LOG.md. Graphic 60% > cap — intentional for technical-process reel. No new toolkit bugs. |
