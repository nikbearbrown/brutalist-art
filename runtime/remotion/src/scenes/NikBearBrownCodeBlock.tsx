...
/**
 * NikBearBrownCodeBlock — simulation CODE beat for NikBearBrown audience.
 * Teardown palette: flat white ground, INK text, CRIMSON red accent.
 * Light code-block; red accent in file tab; lines reveal staggered.
 * Duration-agnostic — vox_compile.py conforms to actual audio length.
 */
export const nikBearBrownCodeBlockSchema = z.object({
    ...
    <AbsoluteFill style={{backgroundColor: VOX.CREAM, overflow: 'hidden'}}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {([VOX.CRIMSON, '#AAA', '#AAA'] as string[]).map((c, i) => (
            <div key={i} style={{
