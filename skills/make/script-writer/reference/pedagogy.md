<!-- VENDORED into vox for self-containment (vox/CLAUDE.md: nothing outside this
     folder is needed). Source of truth: unreal-reels/aspects/explainer/brownblue/
     reference/pedagogy.md. Keep in sync if that file changes. -->
