...
import DATA from './pitch_data.json';
...
export const PITCH_VIDEOS: PitchConfig[] = DATA as PitchConfig[];
...
export const MedPitchReel: React.FC<{ slug: string }> = ({ slug }) => {
  const cfg = PITCH_VIDEOS.find((v) => v.slug === slug)!;
