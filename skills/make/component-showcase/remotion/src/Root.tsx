...
import { ClaudeOversimplified, TOTAL_FRAMES as CO_FRAMES } from './ClaudeOversimplified';
import { TeachersReel, TEACHERS_TOTAL_FRAMES } from './TeachersReel';

// Compositions:
//  - ClaudeForTeachers : claude-for-teachers full reel (Kokoro am_onyx, Liam guest)
//  - claude-oversimplified: THE SLATE CUT — the full 68s data-viz belt-tour (captioned, silent)
