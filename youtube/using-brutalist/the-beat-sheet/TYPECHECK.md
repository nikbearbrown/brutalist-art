...
Reel: `the-beat-sheet`  |  Checked: 2026-07-25T01:40  |  Overall: PASS  |  Beats checked: 9  |  FAILs: 0
...
| VERDICT | ? | min-size §8.1: min text-run height 47px >= floor 35px | PASS | — |
| HANDOFF | ? | min-size §8.1: min text-run height 35px >= floor 35px | PASS | — |
| OUTRO | ? | min-size §8.1: min text-run height 64px >= floor 35px | PASS | — |
